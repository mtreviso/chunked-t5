...
This file contains a simple modification to T5's self attention class in which
a 3-dimensional decoder attention mask can be passed as input, and caching is disabled.
"""
